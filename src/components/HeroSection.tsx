export const HeroSection = () => {
  return (
    <div className="relative overflow-hidden max-w-468 mx-auto">
      <div
        id="tw-scope"
        ...
        <div className="p-15 xl:p-20.75 z-10 rounded-full bg-white/25 dark:bg-[#1A1A1C]/50 border border-[#EDEDED] dark:border-[#232323] circle-shadow backdrop-blur-sm">
          <div className="p-17.5 xl:p-24.25 rounded-full bg-white/50 dark:bg-[#1A1A1C]/50 border border-[#EDEDED] dark:border-[#232323] circle-shadow backdrop-blur-sm">
            <div className="px-30 xl:px-0 w-147.5 xl:w-203 aspect-square rounded-full border border-[#EDEDED] dark:border-[#232323] bg-white dark:bg-[#1A1A1C] circle-shadow flex flex-col items-center justify-center">
              ...
              <div className="flex flex-col justify-center md:flex-row gap-4 mt-8 w-full">
                <a
                  href="#"
      ...
      <img
        className="absolute left-[50%] scale-[1.2] min-[1440px]:scale-[1.1] transform translate-x-[-50%] md:w-full 2xl:w-420 -bottom-46 md:bottom-14 2xl:bottom-0"
        src="./img/chain.png"
        alt=""
      />

      {/* Bottom */}
      <div className="absolute z-50 left-0 right-0 bottom-0 h-80 bg-[linear-gradient(180deg,rgba(250,250,250,0)_0%,#FAFAFA_80.6%)]" />

      {/* Left */}
      <div className="absolute z-50 top-0 bottom-0 hidden min-[1440px]:block -left-12 w-24 bg-[linear-gradient(90deg,#FFFFFF_80.6%,rgba(250,250,250,0)_100%)]" />

      {/* Right */}
      <div className="absolute z-50 top-0 bottom-0 hidden min-[1440px]:block -right-12 w-24 bg-[linear-gradient(270deg,#FFFFFF_80.6%,rgba(250,250,250,0)_100%)]" />
    </div>
  );
};
